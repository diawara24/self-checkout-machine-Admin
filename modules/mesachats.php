<?php 
  ...
  if (isset($_SESSION['pseudo'])) {
    ...
    $sql="SELECT * FROM facture f,articles a,contain c  WHERE f.no_facture=c.code_factu and a.no_article=c.no_artic and f.no_customer=? ORDER BY f.date_facture DESC";
